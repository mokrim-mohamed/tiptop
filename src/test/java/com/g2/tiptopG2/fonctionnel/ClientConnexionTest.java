...
public class ClientConnexionTest {
    ...
    void testLoginSuccess() {
        ...
        usernameField.sendKeys("user2@example.com");
        ...
        wait.until(ExpectedConditions.urlContains("client/participation")); // Redirection attendue
        assertTrue(driver.getCurrentUrl().contains("client/participation"), "Redirection vers le tableau de bord échouée.");
    }
